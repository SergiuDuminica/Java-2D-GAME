...
public class Level1PassedState extends State{

    private UiManager uiManager;
    private BufferedImage levelpassed;
    private static UiManager copy_uiManager;

    public Level1PassedState(Handler handler) {
        super(handler);
        levelpassed = ImageLoader.loadImage("/textures/Level1Completed.png");
        ...
        uiManager.addObject(new UiImageButton(282, 240, 256, 64, Assets.continue_button, new ClickListener() {
            ...
            public void onClick() {
                ...
                handler.getGame().level2State = new Level2State (handler);
                State.setState(handler.getGame().level2State);
            }
        }));
    ...
    public void render(Graphics g) {
        g.drawImage(levelpassed, 0, 0, null);
        uiManager.render(g);
    }
